...
<div class="panel-display radix-brown-pond clearfix <?php if (!empty($classes)) { print $classes; } ?><?php if (!empty($class)) { print $class; } ?>" <?php if (!empty($css_id)) { print "id=\"$css_id\""; } ?>>
  ...
  <div class="container">
    <div class="row-fluid">
      <div class="col-md-12 widemessage panel-panel">
        <div class="panel-panel-inner">
